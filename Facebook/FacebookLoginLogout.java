...
public class FacebookLogin {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("6. Logged into facebook profile");
		Thread.sleep(5000);
